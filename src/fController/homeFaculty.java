...
//            Stage stage = (Stage) node.getScene().getWindow();
//            stage.setScene(new Scene(root));
        	FXMLLoader loader = new FXMLLoader(getClass().getResource("/fView/attendenceFaculty.fxml"));
            Parent root = loader.load();
            
            // Get the controller and set the course ID
            attendenceFaculty controller = loader.getController();
...
//
//            stage.setScene(new Scene(root));
        	 FXMLLoader loader = new FXMLLoader(getClass().getResource("/fView/marksFaculty.fxml"));
             Parent root = loader.load();

             // Get the controller and set the course ID
             marksFaculty controller = loader.getController();
             controller.setCourseId(courseId);
