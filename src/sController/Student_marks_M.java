...
public class Student_marks_M {
    ...
    public ResultSet calculate_obtn_marks(String course, String input)
    {
        ...
        if(input == "Quiz_Marks")
        {
            query = "select marks from quiz where st_id = '"+student_id+"' and course_title = '"+course+"';";
//            System.out.println("Hello........."+student_id+ " " +course+ " ");
    ...
    public ResultSet calculate_nos(String course, String input)
    {
        ...
        if(input == "Quiz_Marks")
        {
            query = "select st_id from quiz where st_id like '"+student_id+"' and course_title like '%"+course+"%';";
        }
        if(input == "Assignments_Marks")
        {
            query = "select st_id from assignment where st_id like '"+student_id+"' and course_title like '%"+course+"%';";
        }
        if(input == "sessional")
        {
            query = "select st_id from sessional where st_id like '"+student_id+"' and course_title like '%"+course+"%';";
        }
        if(input == "final")
        {
            query = "select st_id from final where st_id like '"+student_id+"' and course_title like '%"+course+"%';";
        }
        if(input == "project")
        {
            query = "select st_id from project where st_id like '"+student_id+"' and course_title like '%"+course+"%';";
        }
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(marks) from quiz where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(marks) from assignment where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(marks) from sessional where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(marks) from final where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(marks) from project where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(Total_marks) from project where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(Total_marks) from sessional where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(Total_marks) from quiz where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(Total_marks) from assignment where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
    ...
    {
        cn = db.dbConnector();
        String query = "select sum(Total_marks) from final where st_id like '"+student_id+"' and course_title like '%"+course_id+"%'";
        try {
            st = cn.createStatement();
            rs = st.executeQuery(query);
